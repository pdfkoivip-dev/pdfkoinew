...
- 📋 **Right-Click Menu**: Access PDFkoi tools from any webpage
...
6. The PDFkoi icon should appear in your toolbar!

### Usage

- **Click the icon** in your toolbar to see quick links to popular PDF tools
- **Right-click** on any webpage and select "Open with PDFkoi" to access tools
...
And 64+ more tools via the "Open PDFkoi" button!
...
- ✅ Only opens PDFkoi website when you click
